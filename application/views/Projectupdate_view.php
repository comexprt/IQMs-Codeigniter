...
-->
	...
	<div id="container">
            <div id="wrapper">
               <h1>List of Infrastructure</h1><hr/> 
                <div id="menu">
                    <p>View Project</p>
                ...
                <div id="detail">
					...
					<?php foreach ($single_project as $project): ?>
                        ...
                        <form method="post" action="<?php echo base_url() . "AGUS_site/update_project_id1"?>" enctype="multipart/form-data">
                         <br>
                         <br>
                         <br>
                    ...
                    <?php foreach ($single_project as $project): ?>
                        ...
                        <form method="post" action="<?php echo base_url() . "AGUS_site/update_project_id1"?>">
                            <br>
							<!--br>
							<img src="<?php //echo $project->image;?>" height="250" width="300">
                            <input type="file" name="image" -->

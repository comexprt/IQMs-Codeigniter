...
<body>
	...
	echo form_open("AGUS_site/editvalueSGU6");
					...
					echo"<tr>";
	                      ...
	                      echo" <td><input type='text' id='hide' name='Status1' value='".$row->Status1."'onkeypress='validate(event)' required/><br/></td>";
	                      echo" <td><input type='text' id='hide' name='Remarks1' value='".$row->Remarks1."'onkeypress='validate(event)' required/><br/></td>";
					echo"</tr>";
			...
			echo'<table>';
	                      ...
	                      echo" <td><input type='text' id='hide' name='Status2' value='".$row->Status2."'onkeypress='validate(event)' required/><br/></td>";
	                      echo" <td><input type='text' id='hide' name='Remarks2' value='".$row->Remarks2."'onkeypress='validate(event)' required/><br/></td>";
		
			echo'</table>';
						  echo'<table>';
				   		  echo" <td><input type='text'  readonly id='hide' name='AGUS3' value='".$row->AGUS3."'onkeypress='validate(event)' required/><br/></td>";
	                      echo" <td><input type='text' id='hide' name='Status3' value='".$row->Status3."'onkeypress='validate(event)' required/><br/></td>";
	                      echo" <td><input type='text' id='hide' name='Remarks3' value='".$row->Remarks3."'onkeypress='validate(event)' required/><br/></td>";
		
			echo'</table>';
						  echo'<table>';
				   		  echo" <td><input type='text'  readonly id='hide' name='AGUS4' value='".$row->AGUS4."'onkeypress='validate(event)' required/><br/></td>";
	                      echo" <td><input type='text' id='hide' name='Status4' value='".$row->Status4."'onkeypress='validate(event)' required/><br/></td>";
	                      echo" <td><input type='text' id='hide' name='Remarks4' value='".$row->Remarks4."'onkeypress='validate(event)' required/><br/></td>";
		
			echo'</table>';
						  echo'<table>';
				   		  echo" <td><input type='text'  readonly id='hide' name='AGUS5' value='".$row->AGUS5."'onkeypress='validate(event)' required/><br/></td>";
	                      echo" <td><input type='text' id='hide' name='Status5' value='".$row->Status5."'onkeypress='validate(event)' required/><br/></td>";
	                      echo" <td><input type='text' id='hide' name='Remarks5' value='".$row->Remarks5."'onkeypress='validate(event)' required/><br/></td>";
		
			echo'</table>';
		
	?>		
		<div class="update-generating-unit-status-save-button">
				
				<form>					
					<p class="submit">
						<input type="submit" onClick="return confirm('Save any changes ?')" value="Save" />
					</p>
				</form>

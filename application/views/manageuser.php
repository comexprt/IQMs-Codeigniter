			...
			<!--work here-->
						...
						<div id="delete<?php echo $row->EmID;?>" style="width:350px;height:170px;border-radius:5px;margin-top:-15px;display: none;">
							<div class="login" style="margin-left:20px;">
											...
											<input style='height:30px;font-size:15px;color:#00008C;text-align:center;text-transform:none;' type='hidden' name='EmID' id='EmID' value="<?php echo $row->EmID;?>" onkeypress='validate(event)'  placeholder='Username' required/>										

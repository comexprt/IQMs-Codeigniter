...
<body>
	...
	<div id="outside-wrapper">
		...
		<div id="inside-wrapper"> <!-- width: 1300px color: white -->
			...
			if ($data1=='1'){?>
			<div Style="float:right;color:#8C0000;font-size:14px;font-weight:bold;margin-right:305px;
			margin-top:10px;width:300px;height:20px;">"INVALID USERNAME"</div>
			<?php }else{?>
			<div Style="float:right;color:#8C0000;font-size:14px;font-weight:bold;margin-right:365px;
			margin-top:10px;width:300px;height:20px;">" User  '<?php echo $data1;?>' was Successfully  Changed"</div>
			<?php }?>

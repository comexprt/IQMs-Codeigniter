...
<body>
		...
		<div id="inside-wrapper"> <!-- width: 1300px color: white -->
			...
			<div class="insidemain-content-container"> <!-- width: 1000px; -->
				...
				<div class="content-container">
					...
					<form method="post" action="<?php echo base_url()."AGUS_site/infrasearchE"?>">
            ...
            <div class="cost-centers-search-tool">
			 ...
			 <div class="plantselector" style="float:left;width:70px;">
                <a class="cost-centers-search-button2" style="text-decoration:none;width:70px;padding:10px;background-color: #00238C;"href="<?php echo base_url();?>AGUS_site/ListofProjectE" title="AGUS 6 Infrastructure">
				AGUS 6</a>
			 </div>
			 <div class="plantselector7" style="float:right;width:70px;">
                <a class="cost-centers-search-button2" style="text-decoration:none;width:70px;padding:10px;" href="<?php echo base_url();?>AGUS_site/ListofProjectE7" title="AGUS 7 Infrastructure">
				AGUS 7</a>
			 </div>
			 <?php }else{?>
			 <div class="plantselector" style="float:left;width:70px;">
                <a class="cost-centers-search-button2" style="text-decoration:none;width:70px;padding:10px;"href="<?php echo base_url();?>AGUS_site/ListofProjectE" title="AGUS 6 Infrastructure">
				AGUS 6</a>
			 </div>
			 <div class="plantselector7" style="float:right;width:70px;">
                <a class="cost-centers-search-button2" style="text-decoration:none;width:70px;padding:10px;background-color: #00238C;" href="<?php echo base_url();?>AGUS_site/ListofProjectE7" title="AGUS 7 Infrastructure">
				AGUS 7</a>
			 </div>
			 ...
			 <?php }?>
					...
					<div id="content-wrapper" style="border:1px solid #DBDBEA;margin-top:10px;margin-left:33px;height:430px;width:900px;overflow-y:auto;" >
				<br>
	...
	<div class="AddAccomplishment" style="display:<?php echo $display;?>;">
     <form method="post" action="<?php echo base_url() . "AGUS_site/Elpa"?>">

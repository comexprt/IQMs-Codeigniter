...
<body>
	...
	<div id="outside-wrapper">
		...
		<div id="inside-wrapper"> <!-- width: 1300px color: white -->
         ...
         <div class="cost-centers-indicator-message-container light-yellow">
            <h4>You are currently viewing AGUS 6/7's Admin and Finance Division Infrastructure Projects</h4>
        </div>
        
        <div class="cost-centers-yellow-line-boundary"></div>      
        <!-- I'm working -->
        <div class="cost-centers-options-container">
            ...
            <div class="cost-centers-search-tool">
				...
				<input type="hidden" id="costcenter" name="costcenter" value="adfin">
        ...
        <!-- I'm working -->
            ...
            <h2>Plans and Programs of the Admin and Finance Division</h2>
        </div>
...
<div id="add1workorder" style="width:800px;height:390px;border-radius:5px;margin-top:-15px;display: none;">
		...
		<h2>Admin and Finance Division</h2>
		<p>
				<?php
             ...
             echo form_open("AGUS_site/Addworkorderotpm");	
				...
				echo "<div id ='choice_style' style='width:800px;height:80px;' >";
					...
					echo "<div id ='choice_style' style='margin-top:25px;float:right;width:650px;height:25px;text-align:center;' >";
						echo "<div >";
					echo"<input style='margin-left:-10px;width:620px;height:15px;color:#000066;text-align:left;' type='text' name='LOCATION' id='LOCATION' onkeypress='validate(event)' placeholder='Location' required/>";
					echo "</div>";
				...
				<div id ='choice_style' style='margin-top:20px;width:800px;height:208px;' >
				   ...
				   <!--end new revise-->
					...
					<input type='hidden' name='costcenter' id='costcenter' value='adfin'>

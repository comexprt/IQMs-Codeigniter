            ...
            buttons: {  
                "Add": function() {  
                  ...
                  $.ajax({  
                    ...
                    $('#id').val(''),  
					//diri rako na dugay...
					<?php foreach ($query1 as $imagedata):
					$x=$imagedata->ProjAccomID; //it must be initialize..
					
					?>
                    $('#ProjAccomID').val('<?php echo $x?>'),  
					<?php endforeach; ?>
                     $('#Description').val(''),  
                    $('#qty').val(''),  
                    $('#Unit').val(''),  
	   ...
	   -moz-box-shadow: 0 10px 25px rgba(0, 0, 0, 0.5);
			...
			<?php foreach ($query1 as $row):?>
				<div class="backtolist3">
					...
					<input style="position: absolute;margin-left:1232px;margin-top:-50px;" 
			...
			<fieldset id='first' >
			<h2><center>UPDATE PROJECT ACCOMPLISHMENT<center></h2>
			...
			<div id="textfield1" style="height:350px;width:1050px;margin-left:120px;">
			...
			<?php foreach ($query1 as $imagedata): ?>
					...
					<input class="contractor" style="margin-left:10px;width:300px;font-weight:bold;" name="contractor" placeholder="Contractor" type="text" value="<?php echo $imagedata->ContName?>"  align="left" required/>
					<br><label for='PROJECT_NAME'>    Rep</label>
					<input class="representative" style="margin-left:70px;width:300px;font-weight:bold;" name="representative" placeholder="Representative" type="text" value="<?php echo $imagedata->RepName?>"  align="left" required/>
			</div>
			<div id="textfield1b" style="margin-top:60px;float:left;width:550px;text-transform: uppercase;font-weight:bold;font-size:12px;">
						<input id='did' name="did" value="<?php echo $imagedata->ProjAccomID?>" type="hidden">
					<br><label for='PROJECT_NAME'>    Effectivity of CONTRACT</label>	
						<input id='EfOfCont' style="margin-left:15px;width:300px;font-weight:bold;" name="EfOfCont" placeholder="MONTH-DAY-YEAR" type="date" value="<?php echo $imagedata->EfOfCont?>" required/>
					<br><label for='PROJECT_NAME'>   Expiration DATE</label>
					<input class="ExpDate" style="margin-left:75px;width:300px;font-weight:bold;" name="ExpDate" placeholder="MONTH-DAY-YEAR" type="date" value="<?php echo $imagedata->ExpDate?>" required/>
					<!--br><label for='PROJECT_NAME'>    Expiration Date</label>
					...
					<br><label for='PROJECT_NAME'>    Rev. Contact amt. </label>	
						<input id='RevContAmount' style="text-align:right;margin-left:65px;width:250px;font-weight:bold;" name="RevContAmount" onkeypress="validate(event)" placeholder="0.00" type="text" value="<?php echo $imagedata->RevContAmount?>" required/>
				
				</div>
			<?php endforeach; ?>
			</div>
	
					<input class="next_btn" style="margin-top:30px;" name="next" type="button" value="Next">
			...
			<div id="titlebar" style="float:right;width:300px;margin-right:60px;height:20px;">
				<p style="font-size:17px;font-weight:bold;">ACCOMPLISHMENT</p>
				  ...
				  <div id="show" style="margin-top:5px;height:209px;">  				 
		...
		$x=$imagedata->ProjAccomID; //it must be initialize..
				...
				echo "<input id='ProjAccomID'  name='ProjAccomID'  type='hidden' value='$x' readonly>";			
        ...
        Are you sure?</p>  
			...
			<div id="textfield1" style="margin-left:20px;height:325px">
				...
				<br>
				    ...
				    <br>
						<input id='INFRA_NO' style="margin-left:170px;width:300px;text-align:center;font-weight:bold" name="pbname" placeholder="name" type="text" value="<?php echo "$row->pbname"?>" required/>
						<input id='INFRA_NO' style="margin-left:250px;width:300px;text-align:center;font-weight:bold" name="cbname" placeholder="name" type="text" value="<?php echo "$row->cbname"?>" required/>
				    <div for='personnel' style="margin-top:-20px;">
						<input id='INFRA_NO' style="margin-left:170px;width:300px;text-align:center;font-weight:bold" name="pbposition" placeholder="position" type="text" value="<?php echo "$row->pbposition"?>" required/>
						<input id='INFRA_NO' style="margin-left:250px;width:300px;text-align:center;font-weight:bold" name="cbposition" placeholder="position" type="text" value="<?php echo "$row->cbposition"?>" required/>
					</div>
				<br>
				
					<label for='personnel' style="margin-left:400px;margin-top:100px;">   Approved by: </label>
				<br>
						<input id='INFRA_NO' style="margin-left:450px;width:300px;text-align:center;font-weight:bold" name="abname" placeholder="Project Name" type="text" value="<?php echo "$row->abname"?>" required/>
						<input id='INFRA_NO' style="margin-top:-8px;margin-left:450px;width:300px;text-align:center;font-weight:bold" name="abposition" placeholder="position" type="text" value="<?php echo "$row->abposition"?>" required/>			  
			</div>
			...
			<!--END OF WORK DESCRIPTION-->
					...
					<input class="submit_btn" onClick="return confirm('Do you want to save any changes ?')" type="submit" value="Submit">

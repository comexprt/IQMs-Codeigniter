...
?>
		<div class="Add">
     <form method="post" action="<?php echo base_url() . "AGUS_site/cpa"?>">
		<input type="hidden" name='cpaID' value="<?php echo "$row->PID"?>">
<?php endforeach; ?>
<?php foreach ($last as $row): ?>

		<input type="hidden" name='last' value="<?php echo "$row->ProjAccomID"?>">
<?php endforeach; ?>
		<input type="submit" value="create">
	</form>
	</div>

			  <div id="tablescroll" style="margin-left:30px;margin-top:-10px;height:350px;overflow-y:auto;border:1px solid #EEEEEE">
...
echo	"</tr>";
 ...
 ?> 
				...
				<div class="backtolist2">
					<form method="post" action="<?php echo base_url()."AGUS_site/ListofProject"?>">

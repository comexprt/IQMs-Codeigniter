...
<body>
	...
	<div id="outside-wrapper">
		...
		<div id="inside-wrapper"> <!-- width: 1300px color: white -->
			...
			<div class="insidemain-content-container"> <!-- width: 1000px; -->
              ...
              <div class="cost-centers-indicator-message-container light-green">
            <h4>You are currently viewing AGUS 6/7's Maintenance Division Infrastructure Projects</h4>
        </div>
        
        <div class="cost-centers-green-line-boundary"></div>
       ...
       <!-- I'm working -->
        <div class="cost-centers-options-container">
            ...
            <div class="cost-centers-search-tool">
				...
				<input type="hidden" id="costcenter" name="costcenter" value="md">
        ...
        <div class="cost-centers-table-heading">
            <h2>Plans and Programs of the Maintenance Division</h2>
        </div>
	...
	<tr>
	 ...
	 /*
	   <th>No.</th>
	    <th class='row-1 row-ID'>Activities</th>
		<th>Cost<br />(in millions)</th>
		<th>Nature</th>
		<th>Target Date</th>
		<th>Infa No.</th>
		<th>Actual Date</th>
             ...
             echo form_open("AGUS_site/Addworkorderotpm");	
				...
				echo "<div id ='choice_style' style='width:800px;height:80px;' >";
					...
					echo "<div id ='choice_style' style='float:right;width:650px;height:25px;' >";
						echo "<div>";
						echo"<input type='text' style='color:#000066;width:620px;height:15px;text-align:center;text-align:left;' name='PROJECT_NAME' id='PROJECT_NAME' onkeypress='validate(event)' placeholder=' Project Name' required/>";
						echo "</div>";
					...
					echo"</div>";
					echo "<div id ='choice_style' style='margin-top:25px;color:#000066;float:right;width:650px;height:25px;text-align:center;' >";
						echo "<div >";
				...
				<div id ='choice_style' style='margin-top:20px;width:800px;height:208px;' >
					...
					<div>
					<input type='text' style='color:#000066;width:150px;text-align:left;height:15px;' name='natureOfContract' id='natureOfContract' onkeypress='validate(event)' placeholder='ex. By Contract' required/>
					</div>
				   ...
				   <!--end new revise-->
					...
					<input type='hidden' name='costcenter' id='costcenter' value='md'>

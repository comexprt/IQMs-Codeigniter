...
<body>
	...
	<div id="outside-wrapper">
        ...
        <div class="cost-centers-indicator-message-container light-skyblue">
            <h4>You are currently viewing AGUS 6/7's Office Of The Plant Manager Infrastructure Projects</h4>
        </div>
        
        <div class="cost-centers-skyblue-line-boundary"></div>
        ...
        <div class="cost-centers-options-container">
            ...
            <div class="cost-centers-search-tool">
				...
				<input type="hidden" id="costcenter" name="costcenter" value="otpm">
        ...
        <div class="cost-centers-table-heading">
            <h2>Plans and Programs of the Office Of The Plant Manager</h2>
        </div>
...
<div id="add1workorder" style="width:800px;height:390px;border-radius:5px;margin-top:-15px;display: none;">
		...
		<h2>Office of the Plant Manager</h2>
		<p>
				<?php
             ...
             echo form_open("AGUS_site/Addworkorderotpm");	
				...
				echo "<div id ='choice_style' style='width:800px;height:80px;' >";
					...
					echo "<div id ='choice_style' style='float:right;width:650px;height:25px;' >";
						echo "<div>";
						echo"<input type='text' style='width:620px;height:15px;text-align:center;text-align:left;color:#000066;' name='PROJECT_NAME' id='PROJECT_NAME' onkeypress='validate(event)' placeholder=' Project Name' required/>";
						echo "</div>";
				...
				<div id ='choice_style' style='margin-top:20px;width:800px;height:208px;' >
				   ...
				   <!--end new revise-->
					...
					<input type='hidden' name='costcenter' id='costcenter' value='otpm'>
